...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes):
        ...
        # self.c2_a = _ChannelShrink(in_planes=256) # Comparative experiments
        # self.c3_a = _ChannelShrink(in_planes=512)
        # self.c4_a = _ChannelShrink(in_planes=1024)
        ...
        # Binary Branch
        self.edge = _EdgeAwareness(in_fea=[256, 512])
